...
class Alert(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column("alert_id", Uuid(as_uuid=True), primary_key=True, default=uuid.uuid4)
    ...
    alert_type: Mapped[Optional[str]] = mapped_column("type", String(64), nullable=True)
